...
@section('title', 'Detail Diagnosa - Klinik')

@section('content')
<section class="blank-content">
    <h3 style="margin-bottom: 1.5rem; color: rgb(33, 106, 178); text-align:left;">Detail Pencatatan Diagnosa</h3>
    ...
    <div class="detail-wrapper">
        ...
        <div class="detail-content">
            ...
            <div class="detail-row">
                <span class="detail-label">Tanggal Diagnosa</span>
    ...
    <div style="margin-top:2rem;">
        <a href="{{ route('pencatatan-diagnosa.index') }}" class="btn-back">Kembali</a>
        <a href="{{ route('pencatatan-diagnosa.edit', $diagnosa->id) }}" class="btn-edit">Edit</a>
    </div>
</section>
