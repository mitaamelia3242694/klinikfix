    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->pasien->diagnosaAwal->diagnosa ?? '-' }}</td>
                <td>{{ $item->pasien->diagnosaAkhir->diagnosa ?? '-' }}</td>
                ...
                <td>
                    <div style="display: flex; gap: 0.4rem; flex-wrap: wrap;">
                        ...
                        <a href="{{ route('manajemen-tindakan.show', $item->id) }}" class="btn btn-info no-underline"><i
