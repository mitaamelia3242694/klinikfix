        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="background-color: #28a745; color: white; padding: 0.3rem 0.6rem; border-radius: 6px;">
                        Sudah
                    </span>
                    @else
                    <span style="background-color: #6c757d; color: white; padding: 0.3rem 0.6rem; border-radius: 6px;">
                        Belum
                    </span>
                    @endif
                </td>
                ...
                <td>
                    <div style="display: flex; gap: 0.4rem; flex-wrap: wrap;">
                        <a href="{{ route('data-kajian-awal.show', $item->id) }}" class="btn btn-info no-underline"><i
                                class="fas fa-eye"></i></a>
                        <a href="{{ route('data-kajian-awal.edit', $item->id) }}"
                            class="btn btn-warning no-underline"><i class="fas fa-pen"></i></a>
                        <form action="{{ route('data-kajian-awal.destroy', $item->id) }}" method="POST"
