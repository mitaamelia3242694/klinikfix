    ...
    <ul class="nav">
        ...
        @if ($role === 'Perawat')
            ...
            <li class="{{ request()->routeIs('data-kajian-awal.index') ? 'active' : '' }}">
                <a href="{{ route('data-kajian-awal.index') }}"><i class="fas fa-file-medical-alt"></i> <span>Data
                        Kajian
                        Awal</span></a>
            </li>
            <li class="{{ request()->routeIs('data-diagnosa-awal.index') ? 'active' : '' }}">
                <a href="{{ route('data-diagnosa-awal.index') }}"><i class="fas fa-notes-medical"></i> <span>Data
                        Diagnosa Awal</span></a>
            </li>
            <li class="{{ request()->routeIs('manajemen-tindakan.index') ? 'active' : '' }}">
                <a href="{{ route('manajemen-tindakan.index') }}"><i class="fas fa-briefcase-medical"></i>
                    <span>Manajemen
                        Tindakan</span></a>
            </li>
        @endif
        ...
        @if ($role === 'Apoteker')
            ...
            <li class="{{ request()->routeIs('dashboard-apoteker.index') ? 'active' : '' }}">
                <a href="{{ route('dashboard-apoteker.index') }}"><i class="fas fa-home"></i>
        ...
        @if ($role === 'Admin Stok Obat')
            ...
            <li class="{{ request()->routeIs('dashboard-stokobat.index') ? 'active' : '' }}">
                <a href="{{ route('dashboard-stokobat.index') }}"><i class="fas fa-home"></i>
                    <span>Dashboard</span></a>
            </li>
            <li class="{{ request()->routeIs('menejemen-obat.index') ? 'active' : '' }}">
                <a href="{{ route('menejemen-obat.index') }}"><i class="fas fa-pills"></i> <span>Manage Stok
                        Obat</span></a>
            </li>
        ...
        @if ($role === 'Admin IT')
            ...
            <li class="{{ request()->routeIs('data-jabatan.index') ? 'active' : '' }}">
                <a href="{{ route('data-jabatan.index') }}"><i class="fas fa-id-badge"></i> <span>Data
                        Jabatan</span></a>
            </li>
